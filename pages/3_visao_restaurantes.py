...
def avg_std_time_on_traffic( df1 ):
    df_aux = (df1.loc[:, ['Time_taken(min)', 'City', 'Road_traffic_density']].groupby(['City', 'Road_traffic_density'])
...
with tab1:
    with st.container():
        ...
        with col6:
            ...
            col6.metric('Desvio Padrão Medio de entrega sem festival', df_aux)
    with st.container():
        st.markdown("""___""")
