...
with tab1:
    with st.container():
        ...
        with col3:
            #A melhor condição dos veiculos
            melhor_condicao = df1.loc[:, 'Vehicle_condition'].max()
            col3.metric('Melhor condicao', melhor_condicao)
        with col4:
            #A pior condição dos veiculos
    ...
    with st.container():
        ...
        with col1:
            ...
            df_avg_ratings_per_deliveries = ( df1.loc[:, ['Delivery_person_Ratings', 'Delivery_person_ID']]
                                                .groupby('Delivery_person_ID')
                                                .mean()
                                                .reset_index())
            st.dataframe(df_avg_ratings_per_deliveries)
        with col2:
